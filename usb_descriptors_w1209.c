...
ROM USB_DEVICE_DESCRIPTOR device_dsc={
   ...
   0x0264,                 // Product ID: W1209_PIC (HID)
...
ROM BYTE configDescriptor1[]={
    ...
    9+9+9+7+7,0x00,          // Total length of data for this cfg
...
ROM struct{BYTE bLength;BYTE bDscType;WORD string[18];} sd001={
	...
	{'D','a','r','i','o','\'','s',' ','A','u','t','o','m','a','t','i','o','n'
	}};

//Product string descriptor
ROM struct{BYTE bLength;BYTE bDscType;WORD string[35];} sd002={
	sizeof(sd002),USB_DESCRIPTOR_STRING,
	{'D','a','r','i','o','\'','s',' ','A','u','t','o','m','a','t','i','o','n',' ','T','e','r','m','o','s','t','a','t','o',' ','W','1','2','0','9'
	}};
